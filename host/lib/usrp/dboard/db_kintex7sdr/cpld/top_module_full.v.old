...
// ============================================================================
// top_module.v - Top-level wrapper (FULL UCF pin list) + SPI routing by GPIO SPI_ADDR
// ============================================================================
...
module top_module_full #(
    ...
    // GPIO[3] reserved for CPLD_RST_N if needed
    // --------------------------------------------------------------------
    wire [2:0] spi_addr_from_gpio = {cpld_io_02, cpld_io_01, cpld_io_00};
    wire       cpld_rst_n_from_gpio = cpld_io_03;  // not used yet
    wire       _unused_rst = cpld_rst_n_from_gpio; // avoid "unused" warnings
