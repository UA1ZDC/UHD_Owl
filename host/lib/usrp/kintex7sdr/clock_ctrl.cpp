    ...
    void enable_rx_dboard_clock(bool enb) override {
        switch (static_cast<kintex7sdr_iface::rev_type>(_iface->get_rev())) {
            case kintex7sdr_iface::USRP_N210_XK:
                ...
                _ad9516_regs.output_level_lvds_out6 = ad9516_regs_t::OUTPUT_LEVEL_LVDS_OUT6_7MA;
    ...
    void enable_tx_dboard_clock(bool enb) override {
        switch (static_cast<kintex7sdr_iface::rev_type>(_iface->get_rev())) {
            case kintex7sdr_iface::USRP_N210_XK:
                ...
                _ad9516_regs.output_level_lvds_out7 = ad9516_regs_t::OUTPUT_LEVEL_LVDS_OUT7_7MA;
                break;
            case kintex7sdr_iface::USRP_N210_XA:
                _ad9516_regs.power_down_lvds_cmos_out7 = enb ? 0 : 1;
                _ad9516_regs.lvds_cmos_select_out7 = ad9516_regs_t::LVDS_CMOS_SELECT_OUT7_LVDS;
...
private:
    ...
    void enable_dac_clock(bool enb) {
        switch (static_cast<kintex7sdr_iface::rev_type>(_iface->get_rev())) {
            case kintex7sdr_iface::USRP_N210_XK:
                ...
                _ad9516_regs.output_level_lvpecl_out2 = ad9516_regs_t::OUTPUT_LEVEL_LVPECL_OUT2_960MV;
                ...
                _ad9516_regs.output_level_lvpecl_out3 = ad9516_regs_t::OUTPUT_LEVEL_LVPECL_OUT3_960MV;
                break;
            case kintex7sdr_iface::USRP_N210_XA:
                ...
                _ad9516_regs.output_level_lvpecl_out0 = ad9516_regs_t::OUTPUT_LEVEL_LVPECL_OUT0_960MV;
    ...
    void enable_adc_clock(bool enb) {
        ...
        _ad9516_regs.output_level_lvpecl_out1 = ad9516_regs_t::OUTPUT_LEVEL_LVPECL_OUT1_960MV;
        _ad9516_regs.divider0_bypass = 1;
