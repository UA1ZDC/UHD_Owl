...
module regmap_core #(
    ...
    // Force 24-bit readback format: only low byte is meaningful, upper 16 bits are 0.
    // This removes "no driver" warnings for rd_word_for_cmd[23:8] in CPLD flow.
    assign rd_word_for_cmd = {16'h0000, rd_mux[7:0]};
